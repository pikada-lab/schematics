...
describe('SubApp Factory', () => {
  ...
  it('should manage name only', async () => {
    ...
    expect(files.sort()).toEqual([
      '/nest-cli.json',
      '/apps/pikada-lab-schematics/tsconfig.app.json',
  ...
  it('should manage javascript files', async () => {
    ...
    expect(files.sort()).toEqual([
      '/nest-cli.json',
      '/apps/pikada-lab-schematics/.babelrc',
      '/apps/pikada-lab-schematics/index.js',
      '/apps/pikada-lab-schematics/jsconfig.json',
